...
class PartnerInitialEvaluationReport(models.AbstractModel):
    _inherit = 'report.mgmtsystem_partner_qualification.r_initial_evaluation'
    ...
    def generate_xlsx_report(self, workbook, data, evaluations):
        ...
        for evaluation in evaluations:
            ...
            val_date = evaluation.initial_evaluation_id.date_validate if evaluation.initial_evaluation_id else None
